...
- **Rests** (`03-rests.md`) — the rest glyph displayed always matches the currently selected note value; beamed groups interact with rest substitution (see rests feature).
